...
import com.springrest.book.entities.Courses;
...
public class bookcontroller {
    ...
    public String getAllCourses() {
        String method = "findAllCourses";
        logger.info("Controller Called {}",method);
        return rt.exchange(url+"allCourses", HttpMethod.GET, null, String.class).getBody();
    }

    ////Get course by id
    @GetMapping("/findCourse/{course_id}")
    public String getCourse(@PathVariable long course_id) {
        String method = "findCourse";
        try {
            logger.info("Controller Called {}",method);
            return rt.exchange(url + "allCourses/" + course_id, HttpMethod.GET, null, String.class).getBody();
        } catch (HttpStatusCodeException e) {
            logger.error("Controller Called {}",method);
            return e.toString();
        }
    }
    ...
    public String addCourse(@RequestBody Courses courses) {
        ...
        try {
            logger.info("Controller Called {}", method);
            return rt.postForObject(url + "add", courses, String.class);
        } catch (HttpStatusCodeException e) {
            logger.error("Controller Called {}", method);
            return e.toString();
        }
    ...
    public String deleteBook(@PathVariable long course_id){
        String method = "deleteCourse";
        try {
            logger.info("Controller Called {}",method);
            return rt.exchange(url+"deleteOne/"+course_id, HttpMethod.DELETE, null, String.class).getBody();
        } catch (HttpStatusCodeException e) {
            logger.error("Controller Called {} with {}",method,e.getMessage());
            return e.getMessage();
        }
    }
